...
export default function TournamentPage() {
  ...
  // Загрузка ladder для выбранной лиги (с пагинацией)
            ...
            {leagues.map((lg) => {
              ...
              return (
                <div
                  ...
                  onClick={() => loadLadder(lg, 1)} // новая лига — всегда с 1 страницы
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          e.stopPropagation(); // чтобы не триггерить loadLadder повторно
